...
public class HtmlEntitiesDecoder {
	...
	private static final Pattern entityPattern = Pattern.compile("(&\\S*?;)");

	private static final String decode(String entity) {
	...
	public static String decodeString(String s) {
		...
		while (m.find()) {
			...
			m.appendReplacement(result, whole.replace(entity, decode(entity)));
		}
		m.appendTail(result);
